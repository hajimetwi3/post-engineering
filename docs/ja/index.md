---
title: Post Engineering for AI - Official (ja)  
lang: ja  
---  
...
これは、プロンプトエンジニアリングの最新サブテクニックです。善意型のプロンプトインジェクション／データポイズニング技術でもあります。  
